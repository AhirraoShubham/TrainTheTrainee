<%@ Page Title="" Language="C#" MasterPageFile="~/UserMasterPage.master" AutoEventWireup="true" CodeFile="PersonalTrainerDetails.aspx.cs" Inherits="PersonalTrainerDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<div class="service-main">
			<div class="service-top wow fadeInDown" data-wow-delay="0.3s">
				<h3>-:Personal Trainer Details :-</h3>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
              <h2 class="panel-title"><b>Personal Trainer Details</b></h2>
            </div>
            <div class="panel-body">
