<%@ Page Title="" Language="C#" MasterPageFile="~/UserMasterPage.master" AutoEventWireup="true" CodeFile="TrainerLogin.aspx.cs" Inherits="TrainerLogin" %>
 ...
 <div class="service" style="margin-left:25%">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
              <h2 class="panel-title"><b>Trainer Login</b></h2>
            </div>
            ...
            <tr>
              <td>
                  <a class="fancybox fancybox.iframe" href="TrainerRegistration.aspx">New User?click here..</a>
              </td>
        </tr>
        </table>
        </div>  
