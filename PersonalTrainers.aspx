<%@ Page Title="" Language="C#" MasterPageFile="~/UserMasterPage.master" AutoEventWireup="true" CodeFile="PersonalTrainers.aspx.cs" Inherits="PersonalTrainers" %>
            ...
            <div class="panel-body">
             ...
             <table class="table table-condensed">
                   ...
                   <tr>
                    ...
                    <tr>
                        <td>
                            <a class="fancybox fancybox.iframe" href="PersonalTrainerDetails.aspx?id=<%#Eval("tr_id") %>">Show More</a>
                        </td>
                    </tr>
                </table>
            </div>
