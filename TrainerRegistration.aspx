<%@ Page Title="" Language="C#" MasterPageFile="~/UserMasterPage.master" AutoEventWireup="true" CodeFile="TrainerRegistration.aspx.cs" Inherits="TrainerRegistration" %>
     ...
     <div class="service" style="margin-left:15%">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
              <h2 class="panel-title"><b>Trainer Registration Form</b></h2>
            </div>
